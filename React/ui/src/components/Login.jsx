    ...
    return (
        <div className='w-[450px] rounded-2xl bg-white p-8 flex items-center justify-center flex-col'>
            ...
            <form action="" className='flex flex-col w-full space-y-5'>
                ...
                <p className='text-center'>Don't have an account? <span onClick={()=>setIsLogin(prev => !prev)} className='font-medium text-indigo-600 cursor-pointer hover:text-indigo-800 transition-colors duration-200'>Sign Up</span></p>
            </form>
        </div>
    )
}
