        ...
        <div className='flex items-center justify-center h-[90%] w-full'>
            <div className='w-[450px] rounded-2xl bg-white p-8 flex items-center justify-center flex-col'>
                ...
                <form action="" className='flex flex-col w-full space-y-5'>
                    ...
                    <button type='submit' className='w-full p-3 bg-blue-600 text-white rounded-md cursor-pointer hover:bg-blue-800 transition-colors duration-300'>Sign Up</button>

                    <p className='text-center'>Already have an account? <span onClick={()=> navigate("/signin")} className='font-medium text-indigo-600 cursor-pointer hover:text-indigo-800 transition-colors duration-200'>Sign In</span></p>
                </form>
            </div>
        </div>
    )
